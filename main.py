...
def main(page: ft.Page):
    ...
    avg_stat = ft.Text(NOT_DATA, size=20)
    max_stat = ft.Text(NOT_DATA, size=20)
    min_stat = ft.Text(NOT_DATA, size=20)
    count_stat = ft.Text(NOT_DATA, size=20)
    ...
    if delete_db:
        delete_chart(chart, page, avg_stat, max_stat, min_stat, count_stat)
