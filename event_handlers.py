...
def modify_page_and_settings(page: ft.Page, panel_true: ft.Column | ft.Container, key_true: str, keys_false: tuple):
...
def update_theme(page: ft.Page, line_chart: ft.LineChart, theme: ft.Column, mode: str, icon: str, text: str):
...
def theme_dark_and_light(page: ft.Page, line_chart: ft.LineChart, theme: ft.Column):
